...
#### [#issue8] java 자료형의 범위 (ex. int, long, BigInteger, BigDecimal)
    * int
        * 32bits
...
#### [#issue10] BufferedReader/Scanner, Arrays.sort()/Collections.sort()에 따른 시간복잡도 분석
    * BufferedReader / Scanner (100만개 입력 결과)
        ...
        * Scanner: 2.441(sec) - BufferedReader의 6배
    *  Arrays.sort() / Collections.sort() (100만개 정렬 결과)
        * Arrays.sort(): 0.009(sec)
        * Collections.sort(): ArrayList 자료형의 정렬일 때, 0.028(sec) - Arrays.sort()의 3배
    * 동일 문제에서의 걸린 시간 비교
