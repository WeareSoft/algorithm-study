...
/*
    풀이가 동일하네요.
    굉장히 큰 수 n번째의 피보나치 수열의 값을 구할 때, 주의할 점들이 몇 개 있는 거 같네요.
    1. 기본적인 피보나치 함수를 통해서 구하면 시간 초과 발생.
    2. 배열을 통한 피보나치 수열의 값을 저장할 때 런타임 에러 발생.
    -> f3 = f1 + f2; f3 %= MOD; f1 = f2; f2 = f3; 와 같은 방법을 우선적으로 선택하면 좋을 거 같아요^^
